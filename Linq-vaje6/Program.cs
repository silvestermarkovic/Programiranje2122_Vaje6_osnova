                ...
                switch (ukaz.ToString().ToUpper())
                {
                    ...
                    case "D":
                        ...
                        var _poizvedba = from x in mesta
                                         orderby x 
                                    where x.ToUpper().StartsWith(chzacetek.ToUpper())  //lahko uporabite tudi First in Last
                                         where x.ToUpper().EndsWith(chkonec.ToUpper())
                    ...
                    case "E":
                        ...
                        char[] sezznakiE = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H' };
                        int[] sezstevilaE = { 1, 2, 3, 4 , 5, 6 , 7, 8 };
